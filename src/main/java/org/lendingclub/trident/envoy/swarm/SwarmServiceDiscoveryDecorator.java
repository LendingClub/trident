...
import org.lendingclub.trident.envoy.EnvoyServiceDiscoveryDecorator;
...
public class SwarmServiceDiscoveryDecorator implements EnvoyServiceDiscoveryDecorator {

	Logger logger = LoggerFactory.getLogger(SwarmServiceDiscoveryDecorator.class);
